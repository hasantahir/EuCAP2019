...
\section{Methodology}
%
To simulate the biodegradation of a cardiovascular stent, we used the \emph{Open stents} \cite{bonsignore_open_2012} models that are customizable due to their inherent parameterization. The stent length was set to \SI{25}{\mm} with the diameter in the expanded form equal to \SI{4}{\mm}, as shown in Fig. \ref{fig:stent}.
%
\begin{figure}[h!]
\centering
